...
clang -c  -fPIC -I /usr/local/Cellar/python3/3.5.2_1/Frameworks/Python.framework/Versions/3.5/include/python3.5m libgame.c;
clang -O3 -shared -L /usr/local/Cellar/python3/3.5.2_1/Frameworks/Python.framework/Versions/3.5/lib -l python3.5 libgame.o -o libgame.so;
rm libgame.c;
rm libgame.o;
mv -f libgame.so ../;
cd ..;
